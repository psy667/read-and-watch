...
export const RECORDS_LIST_FILTER_BY_TYPE = "RECORDS_LIST_FILTER_BY_TYPE";
export const RECORDS_LIST_FILTER_BY_STATUS = "RECORDS_LIST_FILTER_BY_STATUS";
export const LOGIN = "LOGIN";
export const RECORDS_LIST_SORT_BY = "RECORDS_LIST_SORT_BY";
export const TYPES_LIST_UPDATE = "TYPES_LIST_UPDATE";
// export const = "";
